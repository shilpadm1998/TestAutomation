...
public class Assignment1 
{
	...
	static void createUser()
	{
		try
		{
			...
			oBrowser.findElement(By.id("userDataLightBox_lastNameField")).sendKeys("shilpa");
			...
			oBrowser.findElement(By.id("userDataLightBox_passwordField")).sendKeys("yashik");
			oBrowser.findElement(By.id("userDataLightBox_passwordCopyField")).sendKeys("yashik");
